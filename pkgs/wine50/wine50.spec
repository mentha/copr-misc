...
Requires: SDL2 SDL2(x86-32)
Requires: cups-libs cups-libs(x86-32)
Requires: dbus-libs dbus-libs(x86-32)
Requires: fontconfig fontconfig(x86-32)
Requires: freetype freetype(x86-32)
Requires: glibc glibc(x86-32)
Requires: gnutls gnutls(x86-32)
Requires: gstreamer1 gstreamer1(x86-32)
Requires: gstreamer1-plugins-base gstreamer1-plugins-base(x86-32)
Requires: krb5-libs krb5-libs(x86-32)
Requires: libX11 libX11(x86-32)
Requires: libXcomposite libXcomposite(x86-32)
Requires: libXcursor libXcursor(x86-32)
Requires: libXext libXext(x86-32)
Requires: libXfixes libXfixes(x86-32)
Requires: libXinerama libXinerama(x86-32)
Requires: libXrandr libXrandr(x86-32)
Requires: libXrender libXrender(x86-32)
Requires: libXxf86vm libXxf86vm(x86-32)
Requires: libcom_err libcom_err(x86-32)
Requires: libglvnd libglvnd(x86-32)
Requires: libjpeg libjpeg(x86-32)
Requires: libpng libpng(x86-32)
Requires: libtiff libtiff(x86-32)
Requires: libunwind
Requires: libusb libusb(x86-32)
Requires: libv4l libv4l(x86-32)
Requires: libvkd3d
Requires: libxml2 libxml2(x86-32)
Requires: libxslt libxslt(x86-32)
Requires: mesa-libOSMesa mesa-libOSMesa(x86-32)
Requires: mpg123-libs mpg123-libs(x86-32)
Requires: ncurses-libs ncurses-libs(x86-32)
Requires: openal-soft openal-soft(x86-32)
Requires: pulseaudio-libs pulseaudio-libs(x86-32)
Requires: systemd-libs systemd-libs(x86-32)
Requires: vulkan-loader vulkan-loader(x86-32)
Requires: zlib zlib(x86-32)
